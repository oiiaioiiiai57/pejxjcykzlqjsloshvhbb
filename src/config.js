...
const DEFAULT_GUILDS = {
  "1479080681572274320": {
    ...
    paidChannel:    "1479080682616520717",
  ...
  "1479133088524009514": {
    ...
    paidChannel:    "1482070966354972682",
...
// Config en mémoire (chargée depuis GitHub au démarrage)
export let GUILDS = { ...DEFAULT_GUILDS };
...
// SITE = ton URL Railway exacte (ex: https://web-production-xxxx.up.railway.app)
