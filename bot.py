...
async def send_stock(ctx, tier):
    ...
    color_map = {"free": 0x57F287, "premium": 0x9B59B6, "paid": 0xF1C40F}
    embed = discord.Embed(title=f"📦 {tier.capitalize()} Stock", description=msg, color=color_map.get(tier, 0xFEE75C))
