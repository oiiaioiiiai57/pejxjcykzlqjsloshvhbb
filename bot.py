...
repo = type('LazyRepo', (), {
    'get_contents': lambda self, *a, **kw: get_repo().get_contents(*a, **kw),
    'update_file':  lambda self, *a, **kw: get_repo().update_file(*a, **kw),
    'create_file':  lambda self, *a, **kw: get_repo().create_file(*a, **kw),
})()
