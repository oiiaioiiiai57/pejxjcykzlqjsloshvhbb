...
async def redeem(interaction: discord.Interaction, code: str):
    ...
    try:
        ...
        await interaction.followup.send(embed=embed_error("Error", str(ex)), ephemeral=True)
...
async def add(interaction: discord.Interaction, tier: app_commands.Choice[str], service: str, file: discord.Attachment):
    ...
    try:
        ...
        return await interaction.followup.send(embed=embed_error("Read Error", str(ex)), ephemeral=True)
...
async def on_app_command_error(interaction: discord.Interaction, error: app_commands.AppCommandError):
    msg = str(error)
    try:
        await interaction.response.send_message(embed=embed_error("An Error Occurred", msg), ephemeral=True)
    except discord.InteractionResponded:
        await interaction.followup.send(embed=embed_error("An Error Occurred", msg), ephemeral=True)
    raise error
